...
set(CORE_FLAGS "-mcpu=cortex-m7 -mthumb")

# Debug flag
set(CORE_FLAGS "${CORE_FLAGS} -g")

# Hardware float support
set(CORE_FLAGS "${CORE_FLAGS} -mfloat-abi=hard -mfpu=fpv5-d16 -ffast-math")

# Compiler flags specific for C++ files
# -std - C++ standard: c++98, gnu++98, c++11, gnu++11, c++14, gnu++14, c++17, gnu++17
...
# fverbose-asm - additional comments for generated assembler code
# -MMD - create dependency files
set(C_FLAGS "-std=gnu11 -O0 --specs=nano.specs -ffunction-sections -fdata-sections -fverbose-asm -MMD")
...
set(LD_SCRIPT ${CMAKE_SOURCE_DIR}/STM32H7A3ZITXQ_FLASH.ld)
# Linker flags
# -Wl, -Map - map file to be created
# -T - file with linker script
# -g - debug flag
# -Wl,--gc-sections - unused function removal
set(LD_FLAGS "-Wl,--print-memory-usage,-Map=${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${CMAKE_PROJECT_NAME}.map,--cref -T${LD_SCRIPT} --specs=nosys.specs -g --specs=nano.specs -Wl,--gc-sections")
